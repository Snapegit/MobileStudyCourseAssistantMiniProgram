				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="学院" prop="xueyuan">
							<el-input class="list_inp" v-model="form.xueyuan" placeholder="学院"
								 type="text" 								:readonly="!isAdd||disabledForm.xueyuan?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='xueyuan'){
					form.value.xueyuan = row[x];
					disabledForm.value.xueyuan = true;
					continue;
				}
				if(x=='banji'){
