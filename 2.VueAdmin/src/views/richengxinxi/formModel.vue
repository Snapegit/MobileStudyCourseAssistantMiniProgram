		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="安排时间" prop="anpaishijian">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.anpaishijian?true:false"
								v-model="form.anpaishijian" 
								placeholder="请选择安排时间"
								>
								<el-option v-for="(item,index) in anpaishijianLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="24">
						<el-form-item label="安排详情" prop="anpaixiangqing">
							<editor :value="form.anpaixiangqing" placeholder="请输入安排详情" :readonly="!isAdd||disabledForm.anpaixiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'anpaixiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.anpaixiangqing = res.data.data.anpaixiangqing?(res.data.data.anpaixiangqing.replace(reg,'../../../cl0498859/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='anpaishijian'){
					form.value.anpaishijian = row[x];
					disabledForm.value.anpaishijian = true;
					continue;
				}
				if(x=='anpaixiangqing'){
					form.value.anpaixiangqing = row[x];
					disabledForm.value.anpaixiangqing = true;
					continue;
				}
				if(x=='xuehao'){
		...
		anpaishijianLists.value = "上午,下午".split(',')
		context?.$http({
