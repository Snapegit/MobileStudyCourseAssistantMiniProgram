				...
				<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
					...
					<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view class="uni-product-list" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"40rpx 0 0 0","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
							<view @tap="onDetailTap(product)" class="uni-product" :style='{"boxShadow":"0 0px 0px #cccccc","margin":"0 0 40rpx 0","backgroundColor":"#ffffff","flexWrap":"wrap","textAlign":"center","display":"flex","width":"48%","justifyContent":"center","height":"auto"}' v-for="(product,index) in list" :key="index">
								<view class="uni-product-title " :style='{"border":"2rpx solid #cdf6f2","padding":"0px 20rpx 0px 20rpx","margin":"0 0 12rpx","whiteSpace":"nowrap","color":"#333333","textAlign":"center","overflow":"hidden","borderRadius":"16rpx","background":"url(http://codegen.caihongy.cn/20230825/5482eae759f84751901c10f294c96a57.png) no-repeat center center / 100%","width":"100%","lineHeight":"72rpx","fontSize":"28rpx","textOverflow":"ellipsis","order":"3","height":"72rpx"}'>{{product.name}}</view>
								<image :style='{"border":"0px solid #eeeeee","padding":"0 0 0 0","boxShadow":"0 6rpx 18rpx #cccccc","margin":"0 0 24rpx 0","objectFit":"cover","borderRadius":"400rpx","display":"inline-block","width":"200rpx","height":"200rpx"}' mode="aspectFill" class="uni-product-image" v-if="preHttp(product.picture)" :src="product.picture"></image>
								<image :style='{"border":"0px solid #eeeeee","padding":"0 0 0 0","boxShadow":"0 6rpx 18rpx #cccccc","margin":"0 0 24rpx 0","objectFit":"cover","borderRadius":"400rpx","display":"inline-block","width":"200rpx","height":"200rpx"}' mode="aspectFill" class="uni-product-image" v-else :src="baseUrl+product.picture"></image>
							</view>
						</view>
					</view>
				</view>
