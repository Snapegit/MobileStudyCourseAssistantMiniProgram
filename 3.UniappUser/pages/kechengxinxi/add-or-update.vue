...
<view class="content">
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#C6EBF130","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="select">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">节数</view>
				<picker :style='{"width":"100%","flex":"1","height":"auto"}' @change="jieshuChange" :value="jieshuIndex"  :range="jieshuOptions">
					<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#666666"}' class="uni-input">{{ruleForm.jieshu?ruleForm.jieshu:"请选择节数"}}</view>
				</picker>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#C6EBF130","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">任课教师</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.renkejiaoshi" v-model="ruleForm.renkejiaoshi" placeholder="任课教师"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#C6EBF130","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="select">
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			// 自定义下拉框值
			this.zhouciOptions = "星期一,星期二,星期三,星期四,星期五,星期六,星期天".split(',')
			// 自定义下拉框值
			this.jieshuOptions = "第一二节,第三四节,第五六节,第七八节,第九十十一节".split(',')
			// 下2
		...
		methods: {
			...
			// 下拉变化
			jieshuChange(e) {
				this.jieshuIndex = e.target.value
				this.ruleForm.jieshu = this.jieshuOptions[this.jieshuIndex]
			},
